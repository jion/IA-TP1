...
public class LaberintosEstado extends EnvironmentState {
    ...
    private static final char[][] nivel1 = {
				{0x87, 0x09, 0x07, 0x01, 0x03, 0x09, 0x05, 0x03, 0x0B, 0x0D},
				...
				{0x0E, 0x06, 0x03, 0x03, 0x03, 0x03, 0x0B, 0x06, 0x03, 0x6A}};
    ...
    private static final char[][] nivel2 = { 
				...
				{0x05, 0x01, 0x02, 0x0B, 0x0C, 0x06, 0x09, 0x05, 0x03, 0x4B},
				...
				{0x0C, 0x05, 0x09, 0x0C, 0x06, 0x03, 0x08, 0x05, 0x03, 0x03},
				{0x06, 0x08, 0x0C, 0x06, 0x09, 0x05, 0x0A, 0x0C, 0x05, 0x6B},
    ...
    private static final char[][] nivel3 = { 
				{0x05, 0x03, 0x03, 0x01, 0x03, 0x03, 0x03, 0x03, 0x03, 0x6B},
				{0x06, 0x03, 0x0B, 0x04, 0x03, 0x03, 0x03, 0x03, 0x03, 0x09},
				{0x87, 0x09, 0x0D, 0x06, 0x03, 0x03, 0x01, 0x01, 0x09, 0x0C},
				...
				{0x87, 0x0A, 0x1E, 0x0C, 0x04, 0x08, 0x05, 0x01, 0x09, 0x0C},
    ...
    */
    ...
    public void initState() {
    	...
    	ronly.setOrientacion(Orientacion.ESTE);
    }
	...
	public Laberinto getLaberintoActual(){
		Laberinto ret=null;
		if(laberintos.size() > nivelActual) {
			ret = laberintos.get(nivelActual);
		}
